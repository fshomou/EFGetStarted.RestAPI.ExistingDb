...
namespace EFGetStarted.RestAPI.ExistingDb.Controllers
{
    ...
    [Route("api/BlogsGeneric")]
    public class BlogsGenericController : Controller
    {
        private readonly IBlogRepositoryGeneric _BlogsRepository;

        public BlogsGenericController(IBlogRepositoryGeneric blogsRepository)
        {
        ...
        {
            return await this._BlogsRepository.GetAllAsyn();
        }
